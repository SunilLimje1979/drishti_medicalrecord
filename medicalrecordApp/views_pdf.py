...
from drishti_medicalrecord import settings
margin = 7
...
def fi_generateprescriptionpdf(request):
    ...
    if not consultation_id:
        ...
        try:
            ...
            url_doctor_consultation =  'https://drishtis.app/drishti_medicalrecord/api/get_consultation_byconsultationid/' #'http://localhost:8000/medicalrecord/api/get_consultation_byconsultationid/'
            ...
            if doctor_id:
                url_doctor = 'https://drishtis.app/drishti_doctor/api/get_doctor_by_id/'
            ...
            if patient_id:
                ...
                url_patient = 'https://drishtis.app/drishti_pateint/api/get_patient_byid/'
            ...
            if result_consultation:
                ...
                pdf_directory = os.path.join(settings.BASE_DIR, 'staticfiles', 'prescriptionpdfs')
                ...
                url_prefix = "https://drishtis.app/drishti_medicalrecord/static/prescriptionpdfs/"
    ...
    if(detail_response.json().get('message_code')==1000):
            ...
            if(prescription_settings['header_type']==2):
                ...
                if(link is not None):
                    ...
                    img_path="https://drishtis.app/drishti_doctor"+updated_link
...
def fi_generateclinicpdf(request):
    ...
    if not doctor_location_id:
        ...
        try:
            ...
            url_doctor_location = 'https://drishtis.app/drishti_doctor/api/get_all_doctor_location/'
...
def generate_clinic_pdf(result_doctor_location,result_doctor,result_doctor_location_availability):
    ...
    flowables.extend([table])
    medilineapp = "this facility powered by Appwelt Pvt. Ltd."
